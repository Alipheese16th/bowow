		...
		<div id="review-form">
			<div class="review-title">리뷰쓰기</div>
				<div class="review-wrap">
					<form action="${conPath}/review/write.do" method="post" enctype="multipart/form-data">
						...
						<table>
							...
							<tr>
								<th>이번 상품 어땠나요?</th>
								<td>
									<input type="number" id="input-1-ltr-star-xs"  class="kv-ltr-theme-svg-star rating-loading" value="0" min="0" max="5" dir="ltr" data-size="lg" name="reviewRating">
								</td>
							</tr>
							<tr>
								<th>사진을 첨부해주세요(선택)</th>
								<td class="file-left">
									...
									<input type="file" name=rImage class="rphoto" accept="image/*">
								</td>
							</tr> 
							<tr>
								<th><label for="title">리뷰제목</label></th>
								<td>
									<input type="text" name="reviewTitle" class="rtitle focusB" id="title">
								</td>
							</tr>
							<tr>
								<th><label for="content">리뷰를 남겨주세요</label></th>
								<td>
									<textarea name="reviewContent" id="content" rows="12" cols="90" class="rcontent focusB"></textarea>
								</td>
							</tr>
							<tr>
								<td colspan="2" style="text-align: center;">
									<button type="submit" class="btnStyle">리뷰등록하기</button>
									<button type="reset" class="btnStyle btn2">취소</button>
									<button type="button" class="btnStyle btn2" onclick="history.back();">목록</button>
								</td>
							</tr>
						</table>
					</form>
