...
--SELECT * FROM NOTICE;
-- 3. PRODUCT (상품코드는 대문자 P 에 시퀀스 합친거 / 카테고리는 fashion / food / toy / walking / clean ) ----------------------
...
--SELECT * FROM COLOR;
------ 6. IMAGE 종류 (대표이미지 : title ) (추가대표이미지 : subTitle) / (본문이미지 : content ) ------------------
...
INSERT INTO IMAGE (IMAGENUM, PRODUCTCODE, TYPE, IMAGE)
  VALUES (IMAGE_SEQ.NEXTVAL, 'P0001', 'content', 'flowershirt1.jpg');
INSERT INTO IMAGE (IMAGENUM, PRODUCTCODE, TYPE, IMAGE)
  VALUES (IMAGE_SEQ.NEXTVAL, 'P0001', 'content', 'flowershirt2.jpg');

INSERT INTO IMAGE (IMAGENUM, PRODUCTCODE, TYPE, IMAGE)
  VALUES (IMAGE_SEQ.NEXTVAL, 'P0002', 'title', 'shirt1.jpg');
INSERT INTO IMAGE (IMAGENUM, PRODUCTCODE, TYPE, IMAGE)
  VALUES (IMAGE_SEQ.NEXTVAL, 'P0002', 'subTitle', 'shirt2.jpg');
